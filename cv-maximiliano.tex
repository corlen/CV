...
\begin{tabular}{| l | p{7cm} | p{2cm} | p{2cm} | p{2cm} |}
  ...
  \hline  
  4 months & Development of a completely new financial system using the Reuters Kondor+ platform, interfacing with existing mainframe systems. & Rabobank & Financial & Analyst and Developer \\
  \hline
  1 year and 4 months & Development of a completely new financial system using the Calypso platform, interfacing with existing mainframe systems. & HSBC & Financial & Analyst and Developer \\
  \hline
  7 months & Development of two products for Sony Ericsson cellphone, a level indicator and a chat client & Sony Ericsson/Instituto Atlântico & Developer \\
  \hline
  7 months & Development and maintenance in SABIUS system, a manager software of insurance web based & Stefanini/UNIMED(insurance company) & Analyst/Developer \\
  \hline
  2 years & Design, development and maintenance of a complete intranet solution with Java Web. & CEGÁS & Analyst/Developer \\
  \hline
\end{tabular}
